    ...
    for res in resolutions:
        ...
        with torch.no_grad():
            for idx, batch in tqdm(enumerate(dataloader)):
                ...
                if idx ==0:
                    macs, params = torchinfo.summary(model, input_data=inputs, col_names=["macs"], verbose=0)
                    flops = macs * 2
        ...
        res_list.append(res)
        print(f"Resolution: {res}, Accuracy1: {mean_acc1}, Accuracy2: {mean_acc2}, Accuracy3: {mean_acc3}, FLOPS:{flops_list}")
...
if __name__ == "__main__":
    ...
    wandb.log({"Resolution": res_list, "Accuracy1": acc1_list, "Accuracy2": acc2_list, "Accuracy3": acc3_list,"FLOPS": flops_list})
    wandb.finish()
