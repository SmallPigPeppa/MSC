...
def test_resolutions(model, dataset_path, resolutions,args):
...
if __name__ == "__main__":
    ...
    if args.method == 'resnet50':
        ...
        from mstrain.densenet121 import MSC
        model = MSC.load_from_checkpoint(args.checkpoint_path, args=args)
    elif args.method == 'mobilenetv2':
        from mstrain.mobilenetv2 import MSC
        model = MSC.load_from_checkpoint(args.checkpoint_path, args=args)
    ...
    res_list, acc_list, flops_list = test_resolutions(model, args.dataset_path, resolutions,args)
