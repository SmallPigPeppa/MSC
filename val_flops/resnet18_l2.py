...
def unified_net():
    u_net = resnet18(pretrained=False)
...
class ResNet18_L2(nn.Module):
    def __init__(self):
        ...
        self.large_net = nn.Sequential(
            ...
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1), resnet18(pretrained=False).layer1
        )
        ...
        self.small_net = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True), resnet18(pretrained=False).layer1
        )
