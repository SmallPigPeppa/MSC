...
class MultiScaleNet(nn.Module):
    def __init__(self):
        ...
        self.large_net = nn.Sequential(
            ...
            nn.MaxPool2d(kernel_size=3, stride=2, padding=1),resnet50(pretrained=False).layer1,resnet50(pretrained=False).layer2, resnet50(pretrained=False).layer3
        )
        ...
        self.small_net = nn.Sequential(
            ...
            nn.BatchNorm2d(64),
            nn.ReLU(inplace=True),resnet50(pretrained=False).layer1,resnet50(pretrained=False).layer2, resnet50(pretrained=False).layer3
        )
