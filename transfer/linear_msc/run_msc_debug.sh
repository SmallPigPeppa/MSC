...
#models["vgg16"]="/mnt/mmtech01/usr/liuwenzhuo/code/test-code/MSC-dali/mstrain/checkpoints/vgg16-bn-mstrain/last.ckpt"
#models["mobilenetv2"]="/mnt/mmtech01/usr/liuwenzhuo/code/test-code/MSC-dali/mstrain/checkpoints/mobilenetv2-mstrain/last.ckpt"
...
for dataset in "${datasets[@]}"; do
    ...
    for model in "${!models[@]}"; do
        ...
        CUDA_VISIBLE_DEVICES=$gpu /root/miniconda3/envs/solo-learn/bin/python $script \
            --num_gpus 2 \
            --weight_decay 2e-5 \
            --project msc-transfer-linear-debug \
            --num_workers 8 \
            --batch_size 32 \
